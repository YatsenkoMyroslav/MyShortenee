...
public class AuthenticateController:ControllerBase
{
    ...
    public AuthenticateController(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration)
    {
    ...
    public async Task<IActionResult> Login([FromBody] LoginModel model)
    {
        ...
        if (user != null && res.Succeeded)
        {
            ...
            string role = "User";
            if (string.Equals(user.UserName, "itsadmin", StringComparison.OrdinalIgnoreCase))
                role = "Admin";
